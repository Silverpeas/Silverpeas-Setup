 ...
 * ABREV_ATTRIBAXIS ('
 * @' the abreviated attribute axis specifier) PARENT_STEP ("..") LITERAL (string enclosed by
 * quotation marks or apostrophes) INTEGER (greater or equal to zero) REAL (greater or equal to
 * zero) NAME (a valid Name as specified in W3C XML 1.0 Recommendation)
 */
